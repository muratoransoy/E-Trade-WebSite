...
namespace ETradeAPI.Persistance.Services
{
    public class BasketService : IBasketService
    {
        ...
        readonly IBasketItemReadRespository _basketItemReadRepository;
        readonly IBasketReadRepository _basketReadRepository;

        public BasketService(IHttpContextAccessor httpContextAccessor, UserManager<AppUser> userManager, IOrderReadRepository orderReadRepository, IBasketWriteRepository basketWriteRepository, IBasketItemWriteRepository basketItemWriteRepository, IBasketItemReadRespository basketItemReadRepository, IBasketReadRepository basketReadRepository)
        {
