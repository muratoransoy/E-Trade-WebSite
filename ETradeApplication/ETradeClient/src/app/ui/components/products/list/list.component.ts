...
import { BaseUrl } from 'src/app/contracts/products/base_url';
...
export class ListComponent extends BaseComponent implements OnInit {
  ...
  async addToCard(product: List_Product) {
    ...
    this.customToastrService.message("Ürün sepete eklenmiştir.","Sepet işlemleri", {
